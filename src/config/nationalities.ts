...
export const NATIONALITIES: NationalityDef[] = [
  {
    ...
    first: [
      ...
      'Aldo', 'Renzo', 'Vito', 'Paolo', 'Emilio', 'Rico', 'Sandro', 'Nunzio',
      'Maria', 'Gina', 'Rosa', 'Lucia', 'Bianca', 'Carla', 'Sofia', 'Elena',
    ],
    last: [
  ...
  },
  {
    ...
    first: [
      'Patrick', 'Michael', 'Seamus', 'Declan', 'Liam', 'Eamon', 'Brendan',
      'Cormac', 'Rory', 'Fergus', 'Colm', 'Niall', 'Sean', 'Danny', 'Dennis',
      'Cornelius', 'Jimmy', 'Terrence', 'Padraig', 'Ruairi',
      'Bridget', 'Maeve', 'Siobhan', 'Nora', 'Eileen', 'Kathleen', 'Deirdre',
      'Peg', 'Roisin', 'Aoife',
    ],
    last: [
  ...
  },
  {
    ...
    first: [
      'Meyer', 'Abe', 'Irving', 'Morris', 'Sol', 'Hyman', 'Benny', 'Louis',
      'Jake', 'Max', 'Nathan', 'Saul', 'Herschel', 'Izzy', 'Moe', 'Sam',
      'Lou', 'Bernie', 'Manny', 'Yitzhak',
      'Rose', 'Ida', 'Sadie', 'Esther', 'Miriam', 'Bessie', 'Fanny', 'Ruth',
      'Leah', 'Golda',
    ],
    last: [
  ...
  },
  {
    ...
    first: [
      'Stanislaw', 'Wladyslaw', 'Jozef', 'Kazimierz', 'Tadeusz', 'Bronislaw',
      'Franciszek', 'Zygmunt', 'Henryk', 'Jerzy', 'Marek', 'Piotr', 'Antoni',
      'Stefan', 'Ignacy', 'Wojciech', 'Czeslaw', 'Ryszard',
      'Jadwiga', 'Wanda', 'Halina', 'Stefania', 'Zofia', 'Irena', 'Krystyna',
      'Danuta', 'Bronislawa', 'Agnieszka',
    ],
    last: [
  ...
  },
  {
    ...
    first: [
      'Yannis', 'Dimitri', 'Christos', 'Stavros', 'Nikos', 'Kostas', 'Spiros',
      'Panos', 'Vasilis', 'Aristotle', 'Theo', 'Manolis', 'Gus', 'Elias',
      'Petros', 'Thanasis', 'Lefteris', 'Apostolos',
      'Eleni', 'Kaliope', 'Athena', 'Voula', 'Despina', 'Yiota', 'Anthoula',
  ...
  },
  {
    ...
    */
    first: [
      'Wing', 'Ming', 'Kai', 'Hing', 'Yuen', 'Cheong', 'Sang', 'Tak', 'Wai',
      'Kwok', 'Chun', 'Shun', 'Fai', 'Hon', 'Yat', 'Lok', 'Bing', 'Hung',
      'Mei', 'Lin', 'Yuk', 'Siu', 'Wan', 'Ling', 'Suet', 'Oi', 'Kam', 'Fung',
    ],
    last: [
